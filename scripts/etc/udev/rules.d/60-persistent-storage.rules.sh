#!/bin/sh
#
# Description	: 60-persistent-storage.rules
...
# echo the title.
echo "[udev] Create /etc/udev/rules.d/60-persistent-storage.rules ...";

# The contents of /etc/udev/rules.d/60-persistent-storage.rules file.
cat > $INITRD_DIR/etc/udev/rules.d/60-persistent-storage.rules << "EOF"
...
chmod 644 $INITRD_DIR/etc/udev/rules.d/60-persistent-storage.rules;
chown 0:0 $INITRD_DIR/etc/udev/rules.d/60-persistent-storage.rules;
